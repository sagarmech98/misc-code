...
resource "azurerm_network_interface" "privateip" {
  ...
  ip_configuration {
    name                          = var.name  
    subnet_id                     = "/subscriptions/72129bc2-1be7-4c6e-971e-9375ebd6c232/resourceGroups/Project/providers/Microsoft.Network/virtualNetworks/Project-VN-ROBO/subnets/default"
